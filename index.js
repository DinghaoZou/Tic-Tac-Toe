...
function checkWinner (a, b, c) {
    ...
    b--;
    c--;
    if ((span[a].dataset.player === span[b].dataset.player) && (span[b].dataset.player === span[c].dataset.player) && (span[a].dataset.player === span[c].dataset.player) && (span[b].dataset.player === "x" || span[a].dataset.player === "o") && isGameOver == false) {
